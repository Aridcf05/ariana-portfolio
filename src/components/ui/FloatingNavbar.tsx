...
export const FloatingNavbar = () => {
  ...
  return (
    ...
    >
      <nav className="glass-panel px-6 py-3 rounded-full flex items-center justify-between gap-6 max-w-xl w-full border border-white/10 shadow-2xl shadow-black/50">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="text-[11px] font-mono px-2.5 py-1 rounded-full bg-zinc-900 border border-white/15 text-zinc-300 hover:text-white hover:border-violet-500/50 transition-all"
          ...
          <a
            ...
            className="text-xs font-semibold px-4 py-2 rounded-full bg-white text-black hover:bg-zinc-200 transition-all"
          >
